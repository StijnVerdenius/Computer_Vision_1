function [final_grid_x, final_grid_y] = phillip(image1, image2, visualization, reg_size)
...
if visualization
    [x,y] = meshgrid(2:1:nr_of_regions_horizontal+2,2:1:nr_of_regions_vertical+2);
