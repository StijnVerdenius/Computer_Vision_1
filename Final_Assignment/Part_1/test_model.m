...
% is this the prefictor part? If yes this is the function used below    
% ScoreSVMModel = fitPosterior(SVMModel,X,Y); %this fits a score-to-posterior-probability transformation function to the scores
